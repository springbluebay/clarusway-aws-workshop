...
def main_post():
    ...
    if not (0 < number < 4000):
        return render_template('index.html', dpythoneveloper_name='Spring', not_valid=True)
    return render_template('result.html', developer_name='Spring', number_decimal=number, number_roman=convert(number))
